...
public class IndexController {
	...
	public ModelAndView caegory(@PathVariable("category") String categoryId) {
		return main(categoryId, null, null, null);
	}

	@RequestMapping(value = { "/page/{page}" }, method = RequestMethod.GET)
	public ModelAndView page(@PathVariable("page") String page) {
		return main(null, null, null, page);
	}

	@RequestMapping(value = { "/order/{order}" }, method = RequestMethod.GET)
	public ModelAndView order(@PathVariable("order") String order) {
		return main(null, order, null, null);
	}

	@RequestMapping(value = { "/count/{count}" }, method = RequestMethod.GET)
	public ModelAndView count(@PathVariable("count") String count) {
		return main(null, null, count, null);
	}
	...
	public ModelAndView categoryPage(
		...
		return main(categoryId, null, null, page);
	}

	@RequestMapping(value = { "/count/{count}/page/{page}" }, method = RequestMethod.GET)
	public ModelAndView countPage(@PathVariable("count") String count,
			@PathVariable("page") String page) {
		return main(null, null, count, page);
	}

	@RequestMapping(value = { "/order/{order}/page/{page}" }, method = RequestMethod.GET)
	public ModelAndView orderPage(@PathVariable("order") String order,
			@PathVariable("page") String page) {
		return main(null, order, null, page);
	}

	@RequestMapping(value = { "/order/{order}/count/{count}" }, method = RequestMethod.GET)
	public ModelAndView orderCount(@PathVariable("order") String order,
			@PathVariable("count") String count) {
		return main(null, order, count, null);
	}
	...
	public ModelAndView categoryCount(
			@PathVariable("category") String categoryId,
			@PathVariable("count") String count) {
		return main(categoryId, null, count, null);
	}

	@RequestMapping(value = { "/order/{order}/count/{count}/page/{page}" }, method = RequestMethod.GET)
	public ModelAndView orderCountPage(@PathVariable("order") String order,
			@PathVariable("count") String count,
			@PathVariable("page") String page) {
		return main(null, order, count, page);
	}
	...
	public ModelAndView categoryOrder(
		...
		return main(categoryId, order, null, null);
	}
	...
	public ModelAndView categoryOrderPage(
			...
			@PathVariable("order") String order,
			@PathVariable("page") String page) {
		return main(categoryId, order, null, page);
	}
	...
	public ModelAndView categoryCountPage(
			...
			@PathVariable("count") String count,
			@PathVariable("page") String page) {
		return main(categoryId, null, count, page);
	}
	...
	public ModelAndView categoryOrderCount(
			...
			@PathVariable("order") String order,
			@PathVariable("count") String count) {
		return main(categoryId, order, count, null);
	}
