							<li class="dropdown login-dropdown">
								...
								<ul class="dropdown-menu login-menu">
									<li>
										<form class="form-inline" role="form" action="javascript:login();">
											<div class="input-group input-group-sm login-form-element">
											  <label class="sr-only" for="name"><zmt:message key="login_colon"/></label> 
											  <input type="text" class="form-control" id="name" placeholder="<zmt:message key='login_colon'/>">
											</div>
											<div class="input-group input-group-sm login-form-element">
												<label class="sr-only" for="password"><zmt:message key="password_colon"/></label>
												<input type="password" class="form-control"	id="password" placeholder='<zmt:message key="password_colon"/>'>
											</div>
											<div class="checkbox login-form-element">
												<label> <input type="checkbox" id="remember" ><zmt:message key="remember_me"/></label>
											</div>
